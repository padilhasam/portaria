    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-light fw-bold">Dados do Usuário</div>
            <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('perfil.update.configuracao') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                @if(auth()->user()->foto)
                                    <div class="mt-2">
                                        <img id="preview" src="{{ asset('storage/' . auth()->user()->foto) }}" style="height: 80px; border-radius: 50%;">
                                    </div>
                                @else
                                    <div class="mt-2">
                                        <img id="preview" src="#" style="display: none; height: 80px; border-radius: 50%;">
                                    </div>
                                @endif
                            </div>
                ...
                {{-- CONFIGURAÇÕES DO SISTEMA (SOMENTE PARA ADMIN) --}}
                @can('isAdmin')
