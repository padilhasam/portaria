                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end show-on-top">
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-2" href="{{route('edit.usuario', ['id' => $usuario->id])}}">
                                                ...
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-2 text-danger" href="javascript:void(0)" type="button" data-bs-toggle="modal" data-bs-target="#removeItemModal-{{ $usuario->id }}">
